            ...
            <nav class="navbar-color">
                ...
                <ul class="left">                      
                      ...
                      <ul class="right hide-on-med-and-down">                        
                          <li><a href="#" class="waves-effect waves-block waves-light"><h1 class="drop-shop animate-character">DROPSHOP <i class="fa-solid fa-cart-shopping"></i></h1></a>
                    </ul>				
                </div>
            </nav>
        </div>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="images/avatar.jpg" style="margin-left:-67px" class="circle responsive-img valign profile-image">
                </div>
      ...
      <section id="content">
        ...
        <div class="container">
          ...
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3" style="margin-left: 100px">
